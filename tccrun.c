...
#define tcc__new_funcitem(symbol_name) {.name=#symbol_name,.val=&symbol_name}

struct tcc__runtime_funcitem{
    char *name;
    void *val;
};

static struct tcc__runtime_funcitem tcc__runtime_funclist[]={
    //memory
    tcc__new_funcitem(malloc),tcc__new_funcitem(realloc),tcc__new_funcitem(free),tcc__new_funcitem(memmove),tcc__new_funcitem(memcpy),
    //basic IO 
    tcc__new_funcitem(fopen),tcc__new_funcitem(fclose),tcc__new_funcitem(fread),tcc__new_funcitem(fwrite),tcc__new_funcitem(fseek),
    ...
    tcc__new_funcitem(tcc_set_error_func),tcc__new_funcitem(tcc_get_error_func),tcc__new_funcitem(tcc_get_error_opaque),
    tcc__new_funcitem(tcc_set_options),tcc__new_funcitem(tcc_add_include_path),tcc__new_funcitem(tcc_add_sysinclude_path),
    tcc__new_funcitem(tcc_define_symbol),tcc__new_funcitem(tcc_undefine_symbol),tcc__new_funcitem(tcc_add_file),
    tcc__new_funcitem(tcc_compile_string),tcc__new_funcitem(tcc_set_output_type),tcc__new_funcitem(tcc_add_library_path),
    tcc__new_funcitem(tcc_add_symbol),tcc__new_funcitem(tcc_output_file),
    tcc__new_funcitem(tcc_relocate),tcc__new_funcitem(tcc_get_symbol),tcc__new_funcitem(tcc_list_symbols),
    */
    {"",NULL}
};

ST_FUNC void tcc_add_runtime_funclist(TCCState *s1){
    for(struct tcc__runtime_funcitem *p=tcc__runtime_funclist;p->val!=NULL;p++){
        tcc_add_symbol(s1,p->name,p->val);
    }
}
